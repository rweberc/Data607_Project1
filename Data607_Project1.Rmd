...
### Read in data  
```{r}
#fileName <- getURL("https://raw.githubusercontent.com/rweberc/Data607_Project1/master/rawdata.txt")
#fileName <- "/Users/ryanweber/Desktop/CUNY/Data 607 Db/Projects/Project 1/rawdata.txt"
...
I believe the warning here is due to their not being a name for the column after the final pipe
```{r}
